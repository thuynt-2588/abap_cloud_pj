CLASS zcl_fill_flights DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fill_flights IMPLEMENTATION.
...
*    Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT ZSFLIGHTS FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table ZSFLIGHTS| ).
